  ...
  useEffect(() => {
    const loadMembers = async () => {
      try {
        ...
        const filteredMembers = shuffleArray(memberData)
          .map(member => {
            const imagePath = getImagePath(member['First Name'], member['Last Name']);
            return {
          ...
          .filter(member => member.image !== null); // Filter out members without images
